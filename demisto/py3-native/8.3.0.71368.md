# `demisto/py3-native:8.3.0.71368`

## Docker Metadata
- Image Size: 1182.59 MB
- Image ID: `sha256:ac06958f77ea1e4fbc22686a40fd397e247bee427c680eb72b0e0e44efd9da0c`
- Created: `2023-08-16T15:41:35.432764882Z`
- Arch: `linux`/`amd64`
- Command: `["python3"]`
- Environment:
  - `PATH=/usr/local/bin:/home/python/.local/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin`
  - `container=oci`
  - `DOCKER_IMAGE=demisto/py3-native:8.3.0.71368`
...
- Labels:
  ...
  - `org.opencontainers.image.revision:c2003fb2753d9cbb9efa60c6d161f24ee5f3df16`
  - `org.opencontainers.image.version:8.3.0.71368`
  - `release:722`
...
Signatures for demisto/py3-native:8.3.0.71368

SIGNED TAG          DIGEST                                                             SIGNERS
8.3.0.71368         f370c60616759451748d4d200245ab6f0973631e173f55393f4e62e139ea509c   (Repo Admin)

Administrative keys for demisto/py3-native:8.3.0.71368
